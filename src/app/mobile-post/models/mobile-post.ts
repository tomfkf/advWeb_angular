import { IsString, IsNotEmpty, IsOptional, Max, MaxLength, IsNumber, Min, Matches, Validate, ValidateIf, Validator } from "class-validator";
import { Type } from 'class-transformer';
import { TimeFormat,order } from "../../shared/constants/regex";
import { FormGroupValidate } from "../../shared/decorators/validator.decorator";
